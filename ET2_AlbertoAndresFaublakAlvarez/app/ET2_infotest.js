...
let articulo_def_tests = [
    ...
    ['articulo', 'FechaPublicacionR', 21, 'Formato de fecha inválido', 'ADD', 'FechaPublicacionR_format_KO', 'Formato incorrecto'],
    ['articulo', 'FechaPublicacionR', 22, 'Fecha inexistente', 'ADD', 'FechaPublicacionR_value_KO', 'Fecha inválida'],
    ...
    ['articulo', 'FechaPublicacionR', 46, 'Formato de fecha inválido en edición', 'EDIT', 'FechaPublicacionR_format_KO', 'Formato incorrecto'],
    ['articulo', 'FechaPublicacionR', 47, 'Fecha válida en edición', 'EDIT', true, 'Fecha correcta'],
    ['articulo', 'nuevo_FicheropdfA', 48, 'Archivo opcional en edición', 'EDIT', true, 'Sin nuevo fichero'],
    ['articulo', 'nuevo_FicheropdfA', 49, 'Tipo incorrecto en edición', 'EDIT', 'FicheropdfA_type_KO', 'Tipo inválido'],
    ['articulo', 'nuevo_FicheropdfA', 50, 'Nombre inválido en edición', 'EDIT', 'FicheropdfA_name_KO', 'Nombre inválido'],
    // SEARCH
    ['articulo', 'CodigoA', 51, 'Código demasiado largo en búsqueda', 'SEARCH', 'CodigoA_max_size_KO', 'Código demasiado largo'],
    ['articulo', 'CodigoA', 52, 'Código válido en búsqueda', 'SEARCH', true, 'Valor búsqueda correcto'],
    ['articulo', 'AutoresA', 53, 'Autores con caracteres inválidos en búsqueda', 'SEARCH', 'AutoresA_format_KO', 'Caracteres no permitidos'],
    ['articulo', 'AutoresA', 54, 'Autores válidos en búsqueda', 'SEARCH', true, 'Autores correctos'],
    ['articulo', 'TituloA', 55, 'Título demasiado largo en búsqueda', 'SEARCH', 'TituloA_max_size_KO', 'Título demasiado largo'],
    ['articulo', 'TituloA', 56, 'Título válido en búsqueda', 'SEARCH', true, 'Título correcto'],
    ['articulo', 'TituloR', 57, 'Título de revista inválido en búsqueda', 'SEARCH', 'TituloR_format_KO', 'Formato incorrecto'],
    ['articulo', 'TituloR', 58, 'Título de revista válido en búsqueda', 'SEARCH', true, 'Título correcto'],
    ['articulo', 'VolumenR', 59, 'Volumen con caracteres en búsqueda', 'SEARCH', 'VolumenR_format_KO', 'Formato incorrecto'],
    ['articulo', 'VolumenR', 60, 'Volumen válido en búsqueda', 'SEARCH', true, 'Volumen correcto'],
    ['articulo', 'PagIniA', 61, 'Página inicial inválida en búsqueda', 'SEARCH', 'PagIniA_format_KO', 'Formato incorrecto'],
    ['articulo', 'PagIniA', 62, 'Página inicial válida en búsqueda', 'SEARCH', true, 'Página correcta'],
    ['articulo', 'PagFinA', 63, 'Página final inválida en búsqueda', 'SEARCH', 'PagFinA_format_KO', 'Formato incorrecto'],
    ['articulo', 'PagFinA', 64, 'Página final menor que la inicial en búsqueda', 'SEARCH', 'PagFinA_order_KO', 'Orden incorrecto'],
    ['articulo', 'PagFinA', 65, 'Página final válida en búsqueda', 'SEARCH', true, 'Página correcta'],
    ['articulo', 'FechaPublicacionR', 66, 'Formato de fecha inválido en búsqueda', 'SEARCH', 'FechaPublicacionR_format_KO', 'Formato incorrecto'],
    ['articulo', 'FechaPublicacionR', 67, 'Fecha inexistente en búsqueda', 'SEARCH', 'FechaPublicacionR_value_KO', 'Fecha inválida'],
    ['articulo', 'FechaPublicacionR', 68, 'Fecha válida en búsqueda', 'SEARCH', true, 'Fecha correcta'],
    ['articulo', 'ISSN', 69, 'ISSN inválido en búsqueda', 'SEARCH', 'ISSN_format_KO', 'Formato incorrecto'],
    ['articulo', 'ISSN', 70, 'ISSN válido en búsqueda', 'SEARCH', true, 'Formato válido'],
    ['articulo', 'EstadoA', 71, 'Estado inválido en búsqueda', 'SEARCH', 'EstadoA_value_KO', 'Estado no permitido'],
    ['articulo', 'EstadoA', 72, 'Estado válido en búsqueda', 'SEARCH', true, 'Estado permitido'],
];
...
let articulo_tests_fields = [
    ...
    ['articulo', 'FechaPublicacionR', 21, 21, 'ADD', [{ FechaPublicacionR: '2024/01/01' }], 'FechaPublicacionR_format_KO'],
    ['articulo', 'FechaPublicacionR', 22, 22, 'ADD', [{ FechaPublicacionR: '2024-02-30' }], 'FechaPublicacionR_value_KO'],
    ['articulo', 'FechaPublicacionR', 23, 23, 'ADD', [{ FechaPublicacionR: '2024-02-20' }], true],
    ['articulo', 'ISSN', 24, 24, 'ADD', [{ ISSN: '1234-123' }], 'ISSN_format_KO'],
    ['articulo', 'ISSN', 25, 25, 'ADD', [{ ISSN: '1234-1234' }], true],
    ['articulo', 'EstadoA', 26, 26, 'ADD', [{ EstadoA: 'BORRADO' }], 'EstadoA_value_KO'],
    ['articulo', 'EstadoA', 27, 27, 'ADD', [{ EstadoA: 'BORRADOR' }], true],
    // EDIT
    ['articulo', 'AutoresA', 28, 28, 'EDIT', [{ AutoresA: 'Autor@' }], 'AutoresA_format_KO'],
    ['articulo', 'AutoresA', 29, 29, 'EDIT', [{ AutoresA: 'Autor Editado' }], true],
    ['articulo', 'TituloA', 30, 30, 'EDIT', [{ TituloA: 'Titulo!' }], 'TituloA_format_KO'],
    ['articulo', 'TituloA', 31, 31, 'EDIT', [{ TituloA: 'Titulo Editado 2025' }], true],
    ['articulo', 'TituloR', 32, 32, 'EDIT', [{ TituloR: 'Rev!' }], 'TituloR_format_KO'],
    ['articulo', 'TituloR', 33, 33, 'EDIT', [{ TituloR: 'Revista Actualizada' }], true],
    ['articulo', 'VolumenR', 34, 34, 'EDIT', [{ VolumenR: '10000' }], 'VolumenR_range_KO'],
    ['articulo', 'VolumenR', 35, 35, 'EDIT', [{ VolumenR: '8' }], true],
    ['articulo', 'PagIniA', 36, 36, 'EDIT', [{ PagIniA: 'pag' }], 'PagIniA_format_KO'],
    ['articulo', 'PagIniA', 37, 37, 'EDIT', [{ PagIniA: '205' }], true],
    ['articulo', 'PagFinA', 38, 38, 'EDIT', [{ PagIniA: '205', PagFinA: 'fin' }], 'PagFinA_format_KO'],
    ['articulo', 'PagFinA', 39, 39, 'EDIT', [{ PagIniA: '205', PagFinA: '100' }], 'PagFinA_order_KO'],
    ['articulo', 'PagFinA', 40, 40, 'EDIT', [{ PagIniA: '205', PagFinA: '210' }], true],
    ['articulo', 'FechaPublicacionR', 41, 41, 'EDIT', [{ FechaPublicacionR: '2024/05/10' }], 'FechaPublicacionR_format_KO'],
    ['articulo', 'FechaPublicacionR', 42, 42, 'EDIT', [{ FechaPublicacionR: '2024-05-10' }], true],
    // SEARCH
    ['articulo', 'CodigoA', 43, 43, 'SEARCH', [{ CodigoA: 'ABCDEFGHIJKLM' }], 'CodigoA_max_size_KO'],
    ['articulo', 'CodigoA', 44, 44, 'SEARCH', [{ CodigoA: 'AR1' }], true],
    ['articulo', 'AutoresA', 45, 45, 'SEARCH', [{ AutoresA: 'Autor@' }], 'AutoresA_format_KO'],
    ['articulo', 'AutoresA', 46, 46, 'SEARCH', [{ AutoresA: 'Autor' }], true],
    ['articulo', 'TituloA', 47, 47, 'SEARCH', [{ TituloA: 'A'.repeat(151) }], 'TituloA_max_size_KO'],
    ['articulo', 'TituloA', 48, 48, 'SEARCH', [{ TituloA: 'Analisis' }], true],
    ['articulo', 'TituloR', 49, 49, 'SEARCH', [{ TituloR: 'Rev!' }], 'TituloR_format_KO'],
    ['articulo', 'TituloR', 50, 50, 'SEARCH', [{ TituloR: 'Revista' }], true],
    ['articulo', 'VolumenR', 51, 51, 'SEARCH', [{ VolumenR: 'vol' }], 'VolumenR_format_KO'],
    ['articulo', 'VolumenR', 52, 52, 'SEARCH', [{ VolumenR: '22' }], true],
    ['articulo', 'PagIniA', 53, 53, 'SEARCH', [{ PagIniA: 'pag' }], 'PagIniA_format_KO'],
    ['articulo', 'PagIniA', 54, 54, 'SEARCH', [{ PagIniA: '10' }], true],
    ['articulo', 'PagFinA', 55, 55, 'SEARCH', [{ PagFinA: 'fin' }], 'PagFinA_format_KO'],
    ['articulo', 'PagFinA', 56, 56, 'SEARCH', [{ PagIniA: '10', PagFinA: '5' }], 'PagFinA_order_KO'],
    ['articulo', 'PagFinA', 57, 57, 'SEARCH', [{ PagIniA: '10', PagFinA: '20' }], true],
    ['articulo', 'FechaPublicacionR', 58, 58, 'SEARCH', [{ FechaPublicacionR: '2024/01/01' }], 'FechaPublicacionR_format_KO'],
    ['articulo', 'FechaPublicacionR', 59, 59, 'SEARCH', [{ FechaPublicacionR: '2024-02-30' }], 'FechaPublicacionR_value_KO'],
    ['articulo', 'FechaPublicacionR', 60, 60, 'SEARCH', [{ FechaPublicacionR: '2024-02-02' }], true],
    ['articulo', 'ISSN', 61, 61, 'SEARCH', [{ ISSN: '123-1234' }], 'ISSN_format_KO'],
    ['articulo', 'ISSN', 62, 62, 'SEARCH', [{ ISSN: '1234-1234' }], true],
    ['articulo', 'EstadoA', 63, 63, 'SEARCH', [{ EstadoA: 'APROBADO' }], 'EstadoA_value_KO'],
    ['articulo', 'EstadoA', 64, 64, 'SEARCH', [{ EstadoA: 'PUBLICADO' }], true],
];
...
let ubicacion_def_tests = [
    ...
    // SEARCH
    ['ubicacion', 'id_site', 48, 'Identificador demasiado largo en búsqueda', 'SEARCH', 'id_site_max_size_KO', 'Identificador demasiado largo'],
    ['ubicacion', 'id_site', 49, 'Identificador válido en búsqueda', 'SEARCH', true, 'Identificador correcto'],
    ['ubicacion', 'site_latitud', 52, 'Latitud no numérica en búsqueda', 'SEARCH', 'site_latitud_format_KO', 'Formato inválido'],
    ['ubicacion', 'site_latitud', 53, 'Latitud válida en búsqueda', 'SEARCH', true, 'Latitud válida'],
    ['ubicacion', 'site_longitud', 54, 'Longitud fuera de rango en búsqueda', 'SEARCH', 'site_longitud_range_KO', 'Valor fuera de rango'],
    ['ubicacion', 'site_longitud', 55, 'Longitud válida en búsqueda', 'SEARCH', true, 'Longitud válida'],
    ['ubicacion', 'site_altitude', 56, 'Altitud no numérica en búsqueda', 'SEARCH', 'site_altitude_format_KO', 'Formato inválido'],
    ['ubicacion', 'site_altitude', 57, 'Altitud válida en búsqueda', 'SEARCH', true, 'Altitud válida'],
    ['ubicacion', 'site_locality', 58, 'Localidad demasiado larga en búsqueda', 'SEARCH', 'site_locality_max_size_KO', 'Longitud excedida'],
    ['ubicacion', 'site_locality', 59, 'Localidad con caracteres inválidos en búsqueda', 'SEARCH', 'site_locality_format_KO', 'Formato inválido'],
    ['ubicacion', 'site_locality', 60, 'Localidad válida en búsqueda', 'SEARCH', true, 'Localidad correcta'],
    ['ubicacion', 'site_provider_login', 61, 'Proveedor demasiado largo en búsqueda', 'SEARCH', 'site_provider_login_max_size_KO', 'Longitud excedida'],
    ['ubicacion', 'site_provider_login', 62, 'Proveedor con caracteres inválidos en búsqueda', 'SEARCH', 'site_provider_login_format_KO', 'Formato inválido'],
    ['ubicacion', 'site_provider_login', 63, 'Proveedor válido en búsqueda', 'SEARCH', true, 'Proveedor correcto']
];
