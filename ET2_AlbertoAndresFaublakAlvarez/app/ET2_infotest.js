...
let articulo_def_tests = [
    ...
    ['articulo', 'ISSN', 5, 'El ISSN debe seguir el formato 0000-0000', 'ADD', 'ISSN_format_KO', 'Formato incorrecto'],
    ['articulo', 'ISSN', 6, 'ISSN correcto', 'ADD', true, 'Formato válido'],
    ['articulo', 'EstadoA', 7, 'Solo estados permitidos', 'ADD', 'EstadoA_value_KO', 'Estado no permitido'],
    ['articulo', 'EstadoA', 8, 'Estado válido', 'ADD', true, 'Estado permitido'],
    ['articulo', 'nuevo_FicheropdfA', 9, 'El PDF es obligatorio en alta', 'ADD', 'FicheropdfA_required_KO', 'Archivo requerido'],
    ['articulo', 'nuevo_FicheropdfA', 10, 'Tipo de fichero permitido', 'ADD', 'FicheropdfA_type_KO', 'Tipo inválido'],
    ['articulo', 'nuevo_FicheropdfA', 11, 'PDF válido', 'ADD', true, 'Archivo válido'],
    // EDIT
    ['articulo', 'AutoresA', 12, 'Autores inválidos en edición', 'EDIT', 'AutoresA_format_KO', 'Caracteres no permitidos'],
    ['articulo', 'AutoresA', 13, 'Autores válidos en edición', 'EDIT', true, 'Autores correctos'],
    ['articulo', 'TituloA', 14, 'Formato de título incorrecto en edición', 'EDIT', 'TituloA_format_KO', 'Formato inválido'],
    ['articulo', 'TituloA', 15, 'Título válido en edición', 'EDIT', true, 'Título correcto'],
    ['articulo', 'nuevo_FicheropdfA', 16, 'Archivo opcional en edición', 'EDIT', true, 'Sin nuevo fichero'],
    ['articulo', 'nuevo_FicheropdfA', 17, 'Tipo incorrecto en edición', 'EDIT', 'FicheropdfA_type_KO', 'Tipo inválido'],
    // SEARCH
    ['articulo', 'CodigoA', 18, 'Código demasiado largo en búsqueda', 'SEARCH', 'CodigoA_max_size_KO', 'Código demasiado largo'],
    ['articulo', 'CodigoA', 19, 'Código válido en búsqueda', 'SEARCH', true, 'Valor búsqueda correcto'],
    ['articulo', 'AutoresA', 20, 'Autores con caracteres inválidos en búsqueda', 'SEARCH', 'AutoresA_format_KO', 'Caracteres no permitidos'],
    ['articulo', 'AutoresA', 21, 'Autores válidos en búsqueda', 'SEARCH', true, 'Autores correctos'],
    ['articulo', 'TituloA', 22, 'Título demasiado largo en búsqueda', 'SEARCH', 'TituloA_max_size_KO', 'Título demasiado largo'],
    ['articulo', 'TituloA', 23, 'Título válido en búsqueda', 'SEARCH', true, 'Título correcto'],
    ['articulo', 'ISSN', 24, 'ISSN inválido en búsqueda', 'SEARCH', 'ISSN_format_KO', 'Formato incorrecto'],
    ['articulo', 'ISSN', 25, 'ISSN válido en búsqueda', 'SEARCH', true, 'Formato válido'],
    ['articulo', 'EstadoA', 26, 'Estado inválido en búsqueda', 'SEARCH', 'EstadoA_value_KO', 'Estado no permitido'],
    ['articulo', 'EstadoA', 27, 'Estado válido en búsqueda', 'SEARCH', true, 'Estado permitido']
];
...
let articulo_tests_fields = [
    ...
    ['articulo', 'ISSN', 5, 5, 'ADD', [{ ISSN: '1234-123' }], 'ISSN_format_KO'],
    ['articulo', 'ISSN', 6, 6, 'ADD', [{ ISSN: '1234-1234' }], true],
    ['articulo', 'EstadoA', 7, 7, 'ADD', [{ EstadoA: 'BORRADO' }], 'EstadoA_value_KO'],
    ['articulo', 'EstadoA', 8, 8, 'ADD', [{ EstadoA: 'BORRADOR' }], true],
    // EDIT
    ['articulo', 'AutoresA', 9, 9, 'EDIT', [{ AutoresA: 'Autor@' }], 'AutoresA_format_KO'],
    ['articulo', 'AutoresA', 10, 10, 'EDIT', [{ AutoresA: 'Autor Editado' }], true],
    ['articulo', 'TituloA', 11, 11, 'EDIT', [{ TituloA: 'Titulo!' }], 'TituloA_format_KO'],
    ['articulo', 'TituloA', 12, 12, 'EDIT', [{ TituloA: 'Titulo Editado 2025' }], true],
    // SEARCH
    ['articulo', 'CodigoA', 13, 13, 'SEARCH', [{ CodigoA: 'ABCDEFGHIJKLM' }], 'CodigoA_max_size_KO'],
    ['articulo', 'CodigoA', 14, 14, 'SEARCH', [{ CodigoA: 'AR1' }], true],
    ['articulo', 'AutoresA', 15, 15, 'SEARCH', [{ AutoresA: 'Autor@' }], 'AutoresA_format_KO'],
    ['articulo', 'AutoresA', 16, 16, 'SEARCH', [{ AutoresA: 'Autor' }], true],
    ['articulo', 'TituloA', 17, 17, 'SEARCH', [{ TituloA: 'A'.repeat(151) }], 'TituloA_max_size_KO'],
    ['articulo', 'TituloA', 18, 18, 'SEARCH', [{ TituloA: 'Analisis' }], true],
    ['articulo', 'ISSN', 19, 19, 'SEARCH', [{ ISSN: '123-1234' }], 'ISSN_format_KO'],
    ['articulo', 'ISSN', 20, 20, 'SEARCH', [{ ISSN: '1234-1234' }], true],
    ['articulo', 'EstadoA', 21, 21, 'SEARCH', [{ EstadoA: 'APROBADO' }], 'EstadoA_value_KO'],
    ['articulo', 'EstadoA', 22, 22, 'SEARCH', [{ EstadoA: 'PUBLICADO' }], true]
];
